 ...
 */
public class RegisterMemberHandlerOptions extends AbstractResultsHandler implements Handler<HttpServerRequest> {

    private Container container;

    public RegisterMemberHandlerOptions(Vertx vertx, Container container) {
        super(vertx);
